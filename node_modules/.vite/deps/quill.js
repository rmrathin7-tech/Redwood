...
import { n as import_eventemitter3 } from "./eventemitter3-B_zeJ3tI.js";
...
function convertHTML(blot, index, length) {
	...
	if (blot instanceof Text$1) return escapeText(blot.value().slice(index, index + length));
...
//#endregion
export { Module, parchment_exports as Parchment, Range, quill_default as default };
